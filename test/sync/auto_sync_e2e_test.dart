  ...
  testWidgets(
    ...
    database = await pumpTestApp(
      ...
      overrides: [
        ...
        // Simule le moteur de synchro branché sur un Firestore de test :
        // AutoSyncCoordinator (câblé dans AppShellScreen) l'utilisera pour
        // le push débouncé déclenché après l'écriture locale.
